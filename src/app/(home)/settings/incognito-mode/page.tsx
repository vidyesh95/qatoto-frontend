...
export const metadata: Metadata = {
  ...
  title: "Incognito mode · Settings",
  description: "Turn incognito mode on or off in this browser",
};

export default function SettingsIncognitoModeRoute() {
  return <SettingsPreference preference="incognito-mode" />;
}
