...
export const metadata: Metadata = {
  ...
  title: "Google account · Your account",
  description: "Link or unlink your Google account",
};

export default async function YourAccountGoogleRoute() {
  const isViewerSignedIn = await hasCallerSession();
  return (
    <AccountRouteGuard isViewerSignedIn={isViewerSignedIn}>
      <YourAccountPanel panel="google" />
    </AccountRouteGuard>
  );
}
