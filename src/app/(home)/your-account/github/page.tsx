...
export const metadata: Metadata = {
  ...
  title: "GitHub account · Your account",
  description: "Link or unlink your GitHub account",
};

export default async function YourAccountGithubRoute() {
  const isViewerSignedIn = await hasCallerSession();
  return (
    <AccountRouteGuard isViewerSignedIn={isViewerSignedIn}>
      <YourAccountPanel panel="github" />
    </AccountRouteGuard>
  );
}
