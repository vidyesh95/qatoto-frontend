...
export const metadata: Metadata = {
  ...
  title: "Profile photo · Your account",
  description: "Set or remove your Qatoto profile photo",
};

export default async function YourAccountProfilePhotoRoute() {
  const isViewerSignedIn = await hasCallerSession();
  return (
    <AccountRouteGuard isViewerSignedIn={isViewerSignedIn}>
      <YourAccountPanel panel="profile-photo" />
    </AccountRouteGuard>
  );
}
