...
export const metadata: Metadata = {
  ...
  title: "Password · Your account",
  description: "Set or change the password on your Qatoto account",
};

export default async function YourAccountPasswordRoute() {
  const isViewerSignedIn = await hasCallerSession();
  return (
    <AccountRouteGuard isViewerSignedIn={isViewerSignedIn}>
      <YourAccountPanel panel="password" />
    </AccountRouteGuard>
  );
}
