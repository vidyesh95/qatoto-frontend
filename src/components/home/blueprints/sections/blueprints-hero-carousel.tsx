...
export default function BlueprintsHeroCarousel({ slides }: { slides: PublicBlueprintHeroSlide[] }) {
  ...
  return (
    // CAPPED ON MOBILE, UNCHANGED ON DESKTOP. From `md` up this is the same 328x184 card it always
    // was (`md:w-82` + `md:aspect-video`) and it was never a banner there. Under `md` it WAS one:
