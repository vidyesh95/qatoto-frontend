...
export default function CaseStudyLessonLink({ caseStudy }: { caseStudy: CaseStudyBlueprint }) {
  ...
  return (
    <Link
      ...
      className="block border-t border-black/5 px-4 py-3 transition-colors hover:bg-muted/50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#00696E] lg:px-6"
    >
