...
export default function StatPill({
  ...
  return (
    <button
      ...
      className="flex w-full cursor-pointer flex-row items-center justify-center gap-2 rounded-full bg-primary px-2.5 py-1.5 text-sm font-medium text-foreground hover:bg-primary/80 lg:w-24"
    >
