...
import AddressSheet, { type Address, MAX_SAVED_ADDRESSES } from "./address-sheet";
    ...
    <>
      <div className="flex items-center gap-2 px-4 py-2 lg:px-6">
        ...
        <button
          ...
          className="rounded-full border border-[#6F7979] px-4 py-2 text-sm font-medium text-[#00696E] cursor-pointer"
        >
          Change
        </button>
      </div>
