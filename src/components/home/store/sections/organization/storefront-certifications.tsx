          ...
          return (
            ...
            >
              ...
              {certification.scopeSummary && (
                <p className="mt-1.5 text-xs leading-4 tracking-wider text-foreground">
                  {certification.scopeSummary}
                </p>
              )}
              ...
              <div className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-1">
                ...
                {isPlatformApproved ? (
                  <span className="inline-flex items-center gap-1 rounded bg-muted px-2 py-0.5 text-xs leading-4 font-medium tracking-wider text-primary-imprint">
                    <Image
                  ...
                  <span className="rounded bg-muted px-2 py-0.5 text-xs leading-4 font-medium tracking-wider text-outline-strong">
                    Awaiting review
                  </span>
                )}
              </div>
