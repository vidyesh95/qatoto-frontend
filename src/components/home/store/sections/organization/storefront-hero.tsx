...
export default function StorefrontHero({ storefront }: { storefront: OrganizationStorefrontView }) {
  ...
  return (
    <header>
      <div className="relative aspect-16/9 w-full overflow-hidden bg-muted md:aspect-3/1 lg:rounded-b-2xl">
        {coverImageUrl && (
          <Image
            src={coverImageUrl}
            fill
      ...
      <div className="px-4 lg:px-6">
        ...
        <h1 className="mt-3 text-lg leading-7 font-medium tracking-tight text-foreground">
          {storefront.displayName}
        </h1>

        <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1">
          <span className="flex items-center gap-1 text-sm leading-5 tracking-normal text-foreground">
            <Image
          ...
          {declaredProfile?.businessType && (
            <span className="rounded bg-muted px-2 py-0.5 text-xs font-medium tracking-wider text-outline-strong">
          ...
          {declaredProfile?.yearFounded !== null && declaredProfile?.yearFounded !== undefined && (
            <span className="text-xs tracking-wider text-outline-strong">
        ...
        {catalogRating && (
          <div className="mt-2 flex items-center gap-2">
            ...
            <span className="text-sm leading-5 font-medium tracking-normal text-outline-strong">
        ...
        {storefront.summary && (
          <p className="mt-3 text-sm leading-5 tracking-normal text-foreground">
            {storefront.summary}
          </p>
        )}
