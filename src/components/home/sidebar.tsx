...
function IconBag(props: IconSvgProps) {
    return (
        <svg viewBox="0 0 24 24" fill="none" {...props}>
            <path d="M6 8h12l-1 11a2 2 0 01-2 2H9a2 2 0 01-2-2L6 8z" stroke="currentColor" strokeWidth="1.5" />
...
function IconCpu(props: IconSvgProps) {
    return (
        <svg viewBox="0 0 24 24" fill="none" {...props}>
            ...
            <path d="M3 10h2M3 14h2M19 10h2M19 14h2M10 3v2M14 3v2M10 19v2M14 19v2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
    );
}
function IconFlask(props: IconSvgProps) {
    return (
        <svg viewBox="0 0 24 24" fill="none" {...props}>
            <path d="M9 3h6M10 3v6L5.5 18A2.5 2.5 0 008 22h8a2.5 2.5 0 002.5-4L14 9V3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
    );
}
function IconClockRotate(props: IconSvgProps) {
    return (
        <svg viewBox="0 0 24 24" fill="none" {...props}>
            <path d="M21 12a9 9 0 10-3.2 6.9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
...
function IconCart(props: IconSvgProps) {
    return (
        <svg viewBox="0 0 24 24" fill="none" {...props}>
            <path d="M4 6h2l2 12h10l2-8H7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
...
function IconBadgeDollar(props: IconSvgProps) {
    return (
        <svg viewBox="0 0 24 24" fill="none" {...props}>
            ...
            <path d="M9 10c0-1.1 1.2-2 3-2s3 .9 3 2-1 1.7-3 2-3 .9-3 2 1.2 2 3 2 3-.9 3-2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
...
function IconHeadset(props: IconSvgProps) {
    return (
        <svg viewBox="0 0 24 24" fill="none" {...props}>
            <path d="M4 13a8 8 0 0116 0v6a2 2 0 01-2 2h-2v-6h4M4 19h2a2 2 0 002-2v-4H4v6z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
    );
}
            ...
            <div className="h-[calc(100dvh-64px)] overflow-y-auto px-4 py-6">
                ...
                <footer className="space-y-2 text-xs text-gray-600">
                    <div className="flex flex-wrap gap-x-4 gap-y-2">
                        ...
                        <Link className="hover:underline" href="/press">Press</Link>
                        <Link className="hover:underline" href="/copyright">Copyright</Link>
                        <Link className="hover:underline" href="/contact-us">Contact us</Link>
                        <Link className="hover:underline" href="/creator">Creator</Link>
                        <Link className="hover:underline" href="/careers">Careers</Link>
                        <Link className="hover:underline" href="/developers">Developers</Link>
                    </div>
                    <div className="flex flex-wrap gap-x-4 gap-y-2">
                        <Link className="hover:underline" href="/terms">Terms</Link>
                        <Link className="hover:underline" href="/privacy-policy">Privacy Policy</Link>
                        <Link className="hover:underline" href="/policies-and-safety">Policies and Safety</Link>
                        <Link className="hover:underline" href="/how-qatoto-works">How Qatoto works</Link>
                    </div>
