...
// Horizontally scrolling feed of equity-for-skills open roles across all
// projects. Anchored so the Team Building stage card can deep-link here.
export default function OpenRolesRail({ roles }: { roles: OpenRole[] }) {
  return (
    <section id="open-roles" className="scroll-mt-20 space-y-1">
      <SectionHeader title="Join a team for equity" />
