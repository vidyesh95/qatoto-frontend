...
const VIDEO_CATEGORIES: VideoCategory[] = [
  {
    id: "1",
    imageSrc: "/dummy/category_01.avif",
    name: "Manufacturing",
    hoverBg: "group-hover:bg-yellow-100",
  },
  {
    id: "2",
    imageSrc: "/dummy/category_02.avif",
    name: "Robotics",
    hoverBg: "group-hover:bg-blue-100",
  },
  {
    id: "3",
    imageSrc: "/dummy/category_03.avif",
    name: "Immortality",
    hoverBg: "group-hover:bg-red-100",
  },
  {
    id: "4",
    imageSrc: "/dummy/category_04.avif",
    name: "Magic",
    hoverBg: "group-hover:bg-amber-100",
  },
  {
    id: "5",
    imageSrc: "/dummy/category_05.avif",
    name: "Toys",
    hoverBg: "group-hover:bg-green-100",
  },
  {
    id: "6",
    imageSrc: "/dummy/category_06.avif",
    name: "Teleportation",
    hoverBg: "group-hover:bg-blue-100",
  },
  {
    id: "7",
    imageSrc: "/dummy/category_07.avif",
    name: "Fusion Energy",
    hoverBg: "group-hover:bg-green-100",
  },
  {
    id: "8",
    imageSrc: "/dummy/category_08.avif",
    name: "Quantum Computing",
    hoverBg: "group-hover:bg-yellow-100",
  },
  {
    id: "9",
    imageSrc: "/dummy/category_09.avif",
    name: "Neural Interfaces",
    hoverBg: "group-hover:bg-blue-100",
  },
  {
    id: "10",
    imageSrc: "/dummy/category_10.avif",
    name: "Space Mining",
    hoverBg: "group-hover:bg-blue-100",
  },
  {
    id: "11",
    imageSrc: "/dummy/category_11.avif",
    name: "Nanotech",
    hoverBg: "group-hover:bg-red-100",
  },
  {
    id: "12",
    imageSrc: "/dummy/category_12.avif",
