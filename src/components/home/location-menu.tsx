  ...
  return (
    <div>
      <header className="sticky top-0 z-10 bg-background flex flex-row gap-4 items-center p-4 border-b border-black/10">
        ...
        <h2 className="text-xl text-secondary-foreground font-medium">Browse location</h2>
      </header>
      ...
      <div className="px-4 pb-3">
        <input
          ...
          className="w-full rounded-lg border border-black/10 bg-background px-4 py-2 text-sm text-secondary-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
        />
      </div>
      <ul>
