    ...
    <div>
      ...
      <div className="px-4 pb-3">
        <input
          ...
          className="w-full px-4 py-2 text-sm border rounded-lg border-black/10 bg-background text-secondary-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
        />
      </div>
      <ul>
