    ...
    <main>
      ...
      <dl className="px-6 md:px-25 pb-25 text-justify text-sm space-y-4">
        <div>
          <dt>Introduction</dt>
          <dd>
            Qatoto is a video sharing platform that allows users to upload and share videos with
            others. This policy sets out the rules and guidelines for copyright protection on
            Qatoto. Our aim is to ensure that the content on Qatoto is used in a way that is
            respectful to the rights of content owners.
          </dd>
        </div>
        <div>
          <dt>Scope</dt>
          <dd>
            This policy applies to all users of Qatoto, including those who upload videos, view
            videos, and comment on videos. This policy applies to all forms of copyrightable works,
            including but not limited to audio, video, images, text, and software.
          </dd>
        </div>
        <div>
          ...
          <dd>
            ...
            against users who violate the rights of copyright owners. If you believe that a video on
            Qatoto infringes your copyright, please notify us by submitting a takedown notice. We
            will investigate the matter and take appropriate action, which may include removing the
            infringing video.
          </dd>
        </div>
        <div>
