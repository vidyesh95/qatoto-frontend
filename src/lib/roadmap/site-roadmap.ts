  ...
  },
  {
    ...
    destinations: [
      ...
      },
      {
        ...
        label: "Blueprints",
        href: "/blueprints",
        summary: "The hub — a hero, three category links and a teaser rail for each.",
      },
      {
        kind: "route",
        label: "Blueprints — teardowns",
        href: "/blueprints/teardowns",
        summary: "A filterable grid: schematics, CAD breakdowns and bills of materials.",
      },
      {
        kind: "dynamic",
        label: "Blueprints — one teardown",
        pathPattern: "/blueprints/teardowns/[slug]",
        summary: "Specs, an optional walkthrough video and the PDFs the build published.",
        reachedFrom: "A card on /blueprints/teardowns or in the hub's teardown rail.",
      },
      {
        kind: "route",
