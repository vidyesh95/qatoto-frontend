  ...
  },
  {
    ...
    destinations: [
      ...
      },
      {
        ...
        label: "Blueprints",
        href: "/blueprints",
        summary: "Engineering teardowns, prototypes and manufacturing case studies.",
      },
      {
        kind: "dynamic",
        label: "Blueprints — one blueprint",
        pathPattern: "/blueprints/[slug]",
        summary: "Schematics, tolerances, CAD format and the bill-of-materials band.",
        reachedFrom: "A card in any rail on /blueprints.",
      },
      {
        kind: "route",
        label: "Library",
