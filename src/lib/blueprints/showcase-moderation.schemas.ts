...
//
// PLAIN (STRIPPING) `z.object` ON WHAT COMES BACK, `z.strictObject` ON THE DECISION THAT GOES OUT.
 ...
 */
const ShowcaseModerationTeamMemberSchema = z.object({
...
export const ShowcaseReviewItemSchema = z.object({
  ...
  callToAction: z.object({ label: z.string(), url: z.string() }).nullable(),
});
