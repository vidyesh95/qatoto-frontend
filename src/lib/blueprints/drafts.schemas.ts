...
export const BlueprintDraftSummarySchema = z.object({
  draftId: z.string(),
...
export const BlueprintDraftReceiptSchema = z.object({
  draftId: z.string(),
  revision: z.number().int().positive(),
  updatedAt: z.string(),
});
...
export const CreateBlueprintDraftInputSchema = z.strictObject({
  arm: BlueprintDraftArmSchema,
...
export const ReplaceBlueprintDraftInputSchema = z.strictObject({
...
export const DeleteBlueprintDraftReceiptSchema = z.object({
  draftId: z.string(),
});
